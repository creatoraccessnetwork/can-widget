    ...
    function renderPreview() {
      ...
      if (ranked.length) {
        ...
        ranked.forEach(function (r) {
          ...
          sv2.textContent = "Save " + (r.p.plans.length > 1 ? "up to " : "") + fmt(r.mx);
          row.appendChild(sv2);
