...
(function () {
  ...
  if (CFG.builder) (function () {
    ...
    if (!CFG.lede && !(cb && cb.lede)) ledeEl.textContent = "Access over $" +
      ...
      " in discounts on products, events, software, services, and more for Creators and solopreneurs.";
