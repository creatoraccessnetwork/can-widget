...
(function () {
  ...
  if (CFG.builder) (function () {
    ...
    function renderPreview() {
      ...
      var ranked = BP
        .filter(function (pp) { return (bCat === ALL || pp.c.indexOf(bCat) > -1) && pp.plans && pp.plans.length; })
        .map(function (pp) {
          var mx = 0;
      ...
      if (ranked.length) {
        ...
        ranked.forEach(function (r) {
          ...
          sv2.textContent = "Save up to " + fmt(r.mx); /* always "up to" (Avi: consistency) */
          row.appendChild(sv2);
