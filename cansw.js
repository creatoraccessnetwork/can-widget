...
(function () {
  ...
  if (CFG.builder) (function () {
    ...
    function refreshCompanyMenu(keepSelection) {
      ...
      lab.textContent = (bCat === ALL ? "All companies" : bCat) + " (🏆 = best deal anywhere)";
    ...
    function renderDetail() {
      ...
      dt.textContent = p.deal || (isEarn(p) ? "Better revenue split" : "Member-only deal");
      ...
      if (isEarn(p)) {
        ...
        note.innerHTML = "Members earn more on the sales they already make through an <strong>improved revenue split</strong>. Add it and set your current earnings on the slider to factor it in.";
