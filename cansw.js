...
(function () {
  ...
  if (CFG.builder) (function () {
    ...
    var STACK_LABEL = "$" + (Math.floor(stackTotal / 100) * 100).toLocaleString("en-US") + "+";
    var bCat = ALL;
    ...
    if (!CFG.lede && !(cb && cb.lede)) ledeEl.textContent = "CAN members access $" +
    ...
    function renderPreview() {
      ...
      if (bCat === ALL || !CATS[bCat]) {
        ...
        stk.innerHTML = "Stack multiple deals — <strong>" + STACK_LABEL + "</strong> in total savings available";
      ...
      if (ranked.length) {
        ...
        if (moreN > 0) {
          ...
          moreEl.textContent = "+" + moreN + " more member deals";
      ...
      if (tops) {
        ...
        for (var ri = rowEls.length - 1; ri > 0 && clippedRow(rowEls[ri]); ri--) {
          ...
          moreN++;
          if (moreEl) moreEl.textContent = "+" + moreN + " more member deals";
        }
      }
