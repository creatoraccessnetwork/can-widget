...
(function () {
  ...
  if (CFG.builder) (function () {
    ...
    function renderDetail() {
      ...
      var host = detailScroll || detailEl;
      host.innerHTML = "";
    ...
    function render() {
      ...
      if (!unlocked) {
        ...
        if (n > 0 && !dismissed) {
          ...
          if (n > 0) reopenBtn.textContent = "Unlock your budget (" + n + " picked)";
          bCta.hidden = false;
    ...
    gate.addEventListener("submit", function (ev) {
      ...
      if (!/^[^\s@]+@[^\s@]+\.[^\s@]{2,}$/.test(v)) {
        gateErr.textContent = "Enter a valid email to unlock your budget.";
        gateErr.hidden = false;
        gateEmail.focus();
        return;
      }
      if (!gateOptin || !gateOptin.checked) {
        gateErr.textContent = "You need to agree to receive the newsletter to unlock your budget.";
        gateErr.hidden = false;
