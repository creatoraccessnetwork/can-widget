...
(function () {
  ...
  if (CFG.builder) (function () {
    ...
    function render() {
      var n = CART.length;
      if (!unlocked) {
        titleEl2.textContent = n ? "Your budget" : "Calculate your savings";
        countEl.textContent = n ? n + " picked" : "";
