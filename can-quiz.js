...
".canq .phead{display:flex;justify-content:space-between;align-items:center;gap:12px;padding:14px 22px;background:var(--rust);color:#fff}.canq .plabel{font-size:13px;line-height:18px;letter-spacing:1.4px;text-transform:uppercase;font-weight:800;color:#fff}.canq .phead .step{color:rgba(255,255,255,.85)}" +
