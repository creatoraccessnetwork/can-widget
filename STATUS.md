...
- **2026-09-12 round not yet live.** (1) Mirror `main` -> `gh-pages` (can-quiz.js, can-segment.js, segments.json, cansw-v2.js). (2) Write the hero block `1787360000008_0` from `scripts/payloads/home-v3.json` to site theme 2164431783 (new label/note text, "A few quick questions", quiz tag `?v=20260912a`); read it back and diff. Do (1) before (2).
